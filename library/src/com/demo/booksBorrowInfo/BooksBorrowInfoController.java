...
public class BooksBorrowInfoController extends Controller {
	...
	public void returnBook(){
		...
		if(booksBorrowInfo !=null){
			...
			BooksEmployee employee = BooksEmployee.me.findById(booksBorrowInfo.getInt("employee_id"));
			employeeId = employee.getStr("employeeId");
			//图书登记为已借出
			BooksInfo booksInfo = BooksInfo.me.findById(booksBorrowInfo.getInt("booksInfo_id"));
